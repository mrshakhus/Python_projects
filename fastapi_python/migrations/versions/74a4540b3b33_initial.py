...
Revision ID: 74a4540b3b33
Revises: 
Create Date: 2024-05-15 20:06:21.796219
...
def downgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['roles_id'], ['roles.id'], name='users_roles_id_fkey'),
